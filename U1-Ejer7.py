# Ejercicio no.7
#Nombre: tkinter.py
#Objetivo: Escriba una clase con tkinter que cree una ventana con dos campos de texto
# dos etiquetas y cuatros botones que simulen la operación de una calculadora basica.
#Autor: Arroyo Brayan
#Fecha: 05/07/2019
